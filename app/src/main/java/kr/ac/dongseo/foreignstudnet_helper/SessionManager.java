...
public class SessionManager {
    ...
    public void createSession(String mail, String name) {
    ...
    public HashMap<String, String> getProfile() {
        ...
        prof.put(MAIL, pref.getString(MAIL, null));
    ...
    public void logout() {
        if (pref.getString(MAIL, null) != null) {
            AsyncHttpClient client = new AsyncHttpClient();
            String logoutURL = HttpConnectionManager.SERVER_URL + "/logoutUser";
    ...
    public void checkSession() {
        AsyncHttpClient client = new AsyncHttpClient();
        String checkLoginURL = HttpConnectionManager.SERVER_URL + "/getUserInfo";
        client.setCookieStore(myCookies);
